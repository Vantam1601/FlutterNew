...
class _IntroSliderPageState extends State<IntroSliderPage> {
   List<Slide> slides = new List.filled(0,Slide(), growable: true);
@override
  void initState() {
  ...
  List<Widget> renderListCustomTabs(){
    List<Widget> tabs = new List.empty() ;
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                child: Image.asset(
                  currentSlide.pathImage!,matchTextDirection: true ,height: 60,
                ),
              ) ,
              Container(
            ...
            Container(
              ...
              child: Text(
                currentSlide.description! ,style: TextStyle(
                color: Colors.white,
                fontSize: 14 ,
                height: 1.5
              ),
